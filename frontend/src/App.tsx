  ...
  const handleProcess = async () => {
    ...
    setTimeout(() => {
      const mockData = {
        ...
        summaries: files.map((file, i) => ({
          filename: file.name,
          extractive: "Key sentences extracted using TextRank...",
          abstractive: "This paper discusses the application of transformer models in literature review automation...",
          keyThemes: ["Transformers", "NLP", "Summarization"]
        }))
      };
